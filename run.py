...
def main():
    ...
    try:
        ...
        # Ensure a QApplication exists BEFORE any QWidget might be constructed
        # Some modules may indirectly create Qt widgets during import; pre-create the app to be safe
